  ...
  <section class="dashboard">
    ...
    <div v-else class="parties-page contracts-page">
      ...
      <section class="node-detail__section parties-page__section parties-page__results">
        <ContractsBrowser
          v-if="selectedNodeSnapshot"
          :key="selectedNodeSnapshot.id"
          scope="node"
          :node-id="selectedNodeSnapshot.id"
          path="/contracts"
          :title="selectedNodeSnapshot.label"
          :show-node-column="false"
          :show-party-filters="true"
          advanced-filter-id="contracts-advanced-filter"
          loading-message="Loading contracts for this node..."
          empty-message="No active contracts found for this node."
          table-aria-label="Node contracts"
          spinner-label="Updating node contracts"
        />
      </section>
    </div>
  </section>
